  ...
  return (
    <footer className="bg-slate-900">
      <div className="max-w-6xl mx-auto px-6 md:px-8 py-5 md:py-6">
        ...
        {/* Top row: Logo + Links */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 pb-5 border-b border-slate-700">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <span className="text-base font-bold text-white">
                AlphaLens <span className="text-sky-400">AI</span>
              </span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              AI-powered equity research and analysis.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-10 sm:gap-16">
            <div>
              <h4 className="text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Platform</h4>
